...
codedVariablesTxt2 = f'{dataFolder}/data/articleAnswers_notMRE_formatted_2025-05-26_v2.txt' 
unseenTxt = f'{dataFolder}/outputs/predictions-compiled/{targetVar}_{v}_predictions.csv'
