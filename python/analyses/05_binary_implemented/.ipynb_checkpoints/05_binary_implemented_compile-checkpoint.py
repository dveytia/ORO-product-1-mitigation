...
tempDf.loc[tempDf['implemented - mean_prediction']>=0.5,[x for x in tempDf.columns if 'oro_type' in x]].apply(lambda x: np.where(x>0.5,1,0)).sum()

"""
maybe there is a bias because I would have expected more implemented for MRE-Located...
