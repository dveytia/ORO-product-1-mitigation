...
v='2_geoEng' # Version of the script
...
# # Remove irrelevant articles? Or do 'screening' in the same step?
# df = df.loc[df["relevant"] == 1,]

# # Do I plan on adding an additional step for primary research screening?
# # If not, add next line, if yes, comment out:
# df.loc[(df['relevant_allResearch']==1) & (df['relevant']==0),[x for x in df.columns if targetVar in x]] = 0 
