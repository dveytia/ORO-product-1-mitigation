...
```{r, out.width="0.9\\linewidth", include=TRUE, fig.align="center", fig.cap=c("Brazil publications on MRE-Ocean contribute to inflection point in # publications"), echo=FALSE}
...
For CCS, Efficiency and MRE-Ocean, looks like change points in deployment time series -- what could have caused these increases? Could they be related to change points in other time series? While we cannot infer causality, we can say that these change points occur around the same time...
