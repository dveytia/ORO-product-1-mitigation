...
# Narrative synthesis. Investigate drivers of break points
...
plot_ggraph_network <- function(g, cluster_id, cluster_label) {
  ...
  ggraph(g_tidy, layout = "circle") +  # You can try "kk" or "circle" or "fr" for spacing
    geom_edge_fan(aes(width = 1/log1p(weight), 
                       alpha = relative_nsig ,
                      label = scales::number(avg_delay, accuracy = 1),
...
final_plot <- wrap_plots(concept_ggraph_plots, nrow = 2)
final_plot
