...
domestic_shipping_emissions <- reshape2::melt(domestic_shipping_emissions, 
                                     measure.vars = c("2000","2005","2010","2015","2016","2017","2018","2019","2020","2021"),
                                     variable.name = "year",
                                     value.name = "value")

domestic_shipping_emissions$year <- as.Date(paste0(domestic_shipping_emissions$year,"-01-01"))
domestic_shipping_emissions$value <- as.numeric(domestic_shipping_emissions$value)
...
How to compare trends between total volume and efficiency?
