...
ggsave(here::here("figures/supplemental/mitigationDeploymentIndicators.pdf"), width = 7, height=6)
...
postsDat <- reshape2::melt(postsDat[,c("oro_type","year", "n_posts_qry_weighted","n_posts_weighted","weighted_positive")],
                           id.vars = c("oro_type","year"),
                           measure.vars = c("n_posts_qry_weighted","n_posts_weighted","weighted_positive"),
