...
postsDat <- read.csv(here::here("outputs/sentiment_predictions/sentiment_summary_oro_year.csv"))%>%
  mutate(
    ...
    prop_positive = weighted_positive/n_posts_like_weighted
  ) %>%
  select(oro_type, year, n_posts_qry_weighted, n_posts_like_weighted, 
...
postsDat <- postsDat %>%
  mutate(
    variable_name = case_when(
      ...
      variable_name=="n_posts_like_weighted" ~ "N posts (query and like-weighted)",
