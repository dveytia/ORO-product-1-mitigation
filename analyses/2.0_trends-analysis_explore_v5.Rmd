...
knitr::include_graphics(here::here("figures/supplemental/nPublicationsTimeseriesPlots.pdf"))
```
...
```{r plot networks and network metrics for mCDR and MRE OROs}
...
knitr::include_graphics(here::here("figures/supplemental/networks_mCDR_MRE.pdf"))
```
