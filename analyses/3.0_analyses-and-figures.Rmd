...
final_plot_selected <- wrap_plots(concept_ggraph_plots_selected, nrow = 2, widths = c(1,1.2)) +
  plot_annotation(tag_levels = "a", tag_suffix = ")") 
...
ggsave(filename=here::here("figures/main/conceptual_cluster_networks_selected.pdf"), final_plot_selected, width = 10, height = 8)
...
combined <- wrap_plots(plotList, ncol=3, byrow=TRUE,
                       guides="collect", heights = c(1.6,1))+
  plot_annotation(tag_levels = "a", tag_suffix = ")") &
  theme(legend.position = "bottom",
        legend.key.width = unit(0.6, "in"),
        legend.title = element_text(margin = margin(r = 15)))
