...
### Step 2: Create Network from TE edges
...
```{r broad-scale timeseries of all mitigation ORO publications and international policy moments}
...
oro_groups <- list(
  ...
  "narrative" = c("MRE-Ocean", "CDR-OAE","Efficiency")
)
